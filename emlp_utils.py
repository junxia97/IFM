...
class IFM_DNN(nn.Module):
    def __init__(self, inputs, hidden_units, outputs, d_out, sigma, dp_ratio, reg):
        ...
        if reg:
            ...
            self.output = nn.Linear(hidden_units[2], outputs)
        self.embedding = IFM_encoding(inputs, d_out, sigma)
